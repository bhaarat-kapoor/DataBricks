...
CREATE STREAMING LIVE TABLE customers--only incremental table will be picked (recommended for Bronze/Silver)
COMMENT "The customers buying finished products, ingested from /databricks-datasets." --Optional metadata
TBLPROPERTIES ("myCompanyPipeline.quality" = "mapping") --Optional metadata
...
CREATE MATERIALIZED VIEW sales_order_in_la
